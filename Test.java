...
public class Test{
    ...
    public static void main(String args[]){ 
        ...
        System.out.println("Genesis block successfully created for ‚ä‚Ý with 100 coins.");
        PRINT(blockchain);
    
        blockchain = makeTransaction(n, M, blockchain, "‚ä‚Ý", "‚È‚¨‚Ý", 10);
        PRINT(blockchain);

        blockchain = makeTransaction(n, M, blockchain, "‚ä‚Ý", "‚ä‚è‚¦", 50);
        PRINT(blockchain);       
    
        blockchain = makeTransaction(n, M, blockchain, "‚ä‚è‚¦", "‚Æ‚à‚Ý", 60);
        PRINT(blockchain);       

        blockchain = makeTransaction(n, M, blockchain, "‚Æ‚à‚Ý", "‚ä‚Ý",100);
        PRINT(blockchain);  
    
        blockchain = makeTransaction(n, M, blockchain, "‚È‚¨‚Ý", "‚Æ‚à‚Ý",10);
        PRINT(blockchain);
    
        blockchain = makeTransaction(n, M, blockchain, "‚Æ‚à‚Ý", "‚Æ‚à‚Ý",10);
        PRINT(blockchain);
    }  
